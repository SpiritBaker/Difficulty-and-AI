...
NDefines.NAI.PEACE_TERMS_HUMILIATE_VALUE_MAX = 1.0 --Max AI desire for humiliating its enemy.
NDefines.NAI.PEACE_TERMS_HUMILIATE_RIVAL_BASE_MULT = 3.0
NDefines.NAI.PEACE_TERMS_HUMILIATE_VALUE_MAX = 4.0 -- Max AI desire for humiliating its' enemy
...
NDefines.NAI.PEACE_TERMS_RELEASE_VASSALS_BASE_MULT = 0.25	
...
NDefines.NAI.PEACE_TERMS_GOLD_BASE_MULT = 0.25
