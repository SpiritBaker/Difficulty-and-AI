...
NDefines.NAI.DIPLOMATIC_ACTION_SUBSIDIES_PREVIOUS_SUBSIDIES_FACTOR = -50 --AI scoring for giving subsidies based on previous subsidies nation is receiving relative to income.
...
NDefines.NAI.DIPLOMATIC_ACTION_SUBSIDIES_MAX_RELATIVE_INCOME = 0.33	--Max relative monthly income that a country can have for the AI to consider it in need of subsidies.
...
NDefines.NAI.ARTILLERY_FRACTION = 0.26
